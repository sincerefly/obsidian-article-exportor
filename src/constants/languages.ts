...
export const LANGUAGES: Record<string, LanguageStrings> = {
	'zh': {
		...
		imageExportConfig: '导出图像配置',
		imageExportConfigDesc: '配置图像导出的相关设置',
		host: '图床域名地址',
		hostDesc: '图片链接的图床域名地址（例如：https://images.yasking.org）',
		defaultArticleType: '默认笔记类型',
		defaultArticleTypeDesc: '选择默认的笔记类型，如果不设置则每次导出时都会弹出选择对话框',
		articleTypesConfig: '笔记类型配置',
		articleTypesConfigDesc: '配置不同的笔记类型，每个类型可以设置前缀路径',
		...
		noEnabledArticleTypes: '没有启用的笔记类型，请在设置中配置',
		
		// 模态框
		selectArticleType: '选择笔记类型',
		selectArticleTypeDesc: '为文件选择笔记类型：',
		cancel: '取消',
		confirm: '确认',
		...
		// 笔记类型管理
		addNewArticleType: '添加新笔记类型',
		articleTypeName: '类型名称 *',
		articleTypeNameDesc: '输入笔记类型名称，如：Moments、Photos、Reading等',
		...
		addArticleTypeButton: '+ 添加笔记类型',
		pleaseEnterTypeName: '请输入类型名称',
		duplicateTypeName: '已存在相同名称的笔记类型',
		articleTypeAdded: '已添加笔记类型：',
		articleTypeDeleted: '已删除笔记类型：',
		deleteArticleType: '删除',
		confirmDeleteType: '确定要删除笔记类型"',
		confirmDeleteTypeDesc: '"吗？\n\n删除后无法恢复，请谨慎操作。',
		isDefaultType: '"是当前的默认笔记类型。\n\n删除后将清除默认设置，是否继续？',
	...
	'en': {
		...
		imageExportConfig: 'Image Export Configuration',
		imageExportConfigDesc: 'Configure image export settings',
		host: 'Image Host Domain',
		hostDesc: 'Image host domain for URLs (e.g., https://images.yasking.org)',
		defaultArticleType: 'Default Note Type',
		defaultArticleTypeDesc: 'Select default note type, if not set, selection dialog will appear each time',
		articleTypesConfig: 'Note Types Configuration',
		articleTypesConfigDesc: 'Configure different note types, each type can set prefix path',
		...
		noEnabledArticleTypes: 'No enabled note types, please configure in settings',
		
		// 模态框
		selectArticleType: 'Select Note Type',
		selectArticleTypeDesc: 'Select note type for file:',
		cancel: 'Cancel',
		confirm: 'Confirm',
		...
		// 笔记类型管理
		addNewArticleType: 'Add New Note Type',
		articleTypeName: 'Type Name *',
		articleTypeNameDesc: 'Enter note type name, such as: Moments, Photos, Reading, etc.',
		...
		addArticleTypeButton: '+ Add Note Type',
		pleaseEnterTypeName: 'Please enter type name',
		duplicateTypeName: 'Note type with the same name already exists',
		articleTypeAdded: 'Note type added: ',
		articleTypeDeleted: 'Note type deleted: ',
		deleteArticleType: 'Delete',
		confirmDeleteType: 'Are you sure you want to delete note type "',
		confirmDeleteTypeDesc: '"?\n\nThis action cannot be undone, please proceed with caution.',
		isDefaultType: '" is the current default note type.\n\nDeleting will clear the default setting, continue?',
		confirmDeleteDefaultType: '',
		confirmDeleteDefaultTypeDesc: '',
